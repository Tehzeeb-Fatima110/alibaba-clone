...
import { electronics } from '../../data/mockData'
import techBg from '../../assets/Image/backgrounds/Mask group (1).png'
  ...
  return (
    <div className="bg-white rounded border border-gray-100 mb-4 overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-5">
        ...
        >
          <div>
            <h2 className="font-bold text-gray-900 mb-1">Consumer electronics and gadgets</h2>
          </div>
